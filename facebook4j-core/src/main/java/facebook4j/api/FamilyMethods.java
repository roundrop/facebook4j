...
public interface FamilyMethods {
     ...
     * @see <a href="https://developers.facebook.com/docs/reference/api/user/">User - Facebook Developers</a> - Connections - family
     */
    ResponseList<Family> getFamily(String userId) throws FacebookException;
     ...
     * @see <a href="https://developers.facebook.com/docs/reference/api/user/">User - Facebook Developers</a> - Connections - family
     */
    ResponseList<Family> getFamily(String userId, Reading reading) throws FacebookException;
