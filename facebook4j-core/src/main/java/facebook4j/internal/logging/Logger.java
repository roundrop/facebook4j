...
public abstract class Logger {
    ...
    private static final String LOGGER_FACTORY_IMPLEMENTATION = "facebook4j.loggerFactory";

    static {
        LoggerFactory loggerFactory = null;
        //-Dfacebook4j.debug=true -Dfacebook4j.loggerFactory=facebook4j.internal.logging.StdOutLoggerFactory
        ...
        if (null == loggerFactory) {
            loggerFactory = getLoggerFactoryIfAvailable("com.google.appengine.api.urlfetch.URLFetchService", "facebook4j.internal.logging.JULLoggerFactory");
        }
